...
import { ArrowRight, Shield, Leaf, Zap, MessageSquare, Smartphone, Globe, Database, Server, Headphones, Wrench, Palette, Cloud, LineChart, Laptop, FileText, Image, Video, Users, ShoppingCart, Layers, Cpu, BookOpen, Map, PieChart, Briefcase, Lightbulb, Menu, X, Star, Quote, ExternalLink, Github, CheckCircle, Award, TrendingUp, Sparkles, Target, Heart, Rocket } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      {/* Navigation */}
      <nav className="fixed w-full glass-effect z-50 border-b border-blue-100/50">
        ...
        {isMenuOpen && (
          <motion.div 
            ...
            className="md:hidden glass-effect border-t border-blue-100/50"
          >
      ...
      <section className="pt-32 pb-24 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-green-100 rounded-full text-sm font-medium text-gray-700 mb-8 border border-blue-200/50">
              <Sparkles className="w-4 h-4 mr-2 text-blue-500" />
              Trusted by 500+ companies worldwide
              <Award className="w-4 h-4 ml-2 text-green-500" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/pricing">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 group">
              ...
              <Link href="/documentation">
                <Button variant="outline" size="lg" className="border-gray-300 text-gray-700 hover:bg-blue-50 hover:border-blue-300 px-8 py-4 text-lg font-semibold">
      ...
      {/* Stats Section */}
      <section className="py-16 px-6 lg:px-8 bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`group p-8 rounded-2xl ${getColorClasses(service.color, 'bg')} border ${getColorClasses(service.color, 'border')} card-hover`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border ${getColorClasses(project.color, 'border')}`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {majorProjects.map((project, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`group bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border ${getColorClasses(project.color, 'border')}`}
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className={`${getColorClasses(project.color, 'bg')} backdrop-blur-sm text-gray-800 px-4 py-2 rounded-full text-sm font-semibold border ${getColorClasses(project.color, 'border')}`}>
                      {project.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" className="flex-1 border-gray-300 hover:bg-gray-50" asChild>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border ${getColorClasses(testimonial.color, 'border')} relative`}
              >
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 lg:px-8 bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/50 via-gray-900 to-green-900/50"></div>
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/pricing">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 group">
                  <Rocket className="w-5 h-5 mr-2" />
                  Start Your Project
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <Button variant="outline" size="icon" className="border-gray-300 hover:bg-blue-50 hover:border-blue-300">
                  <Github className="w-5 h-5" />
                </Button>
                <Button variant="outline" size="icon" className="border-gray-300 hover:bg-green-50 hover:border-green-300">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li><Link href="#" className="hover:text-green-600 transition-colors">Mobile Apps</Link></li>
                <li><Link href="#" className="hover:text-yellow-600 transition-colors">UI/UX Design</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li><Link href="/documentation" className="hover:text-green-600 transition-colors">Documentation</Link></li>
                <li><Link href="/get-started" className="hover:text-yellow-600 transition-colors">Contact</Link></li>
              </ul>
            </div>
          </div>
